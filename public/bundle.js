...
var _exports2 = __webpack_require__(9);
...
var Button = function (_Component) {
  ...
  _createClass(Button, [{
    ...
    value: function render(props) {
      return (0, _preact.h)(
        'a',
        { className: (0, _aphrodite.css)(styles.button, props.inactive ? styles.inactive : null), onClick: props.click },
        props.content
      );
    }
  }]);
...
var _stringHash = __webpack_require__(33);
...
var _Answer = __webpack_require__(35);
...
var _OperatorBar = __webpack_require__(36);

var _OperatorBar2 = _interopRequireDefault(_OperatorBar);

var _Question = __webpack_require__(37);

var _Question2 = _interopRequireDefault(_Question);

var _SelectorBar = __webpack_require__(39);
...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.generateQuestion = _this.generateQuestion.bind(_this);
  ...
  _createClass(App, [{
    key: 'toggleSelector',
    value: function toggleSelector(number) {
    ...
    value: function generateQuestion() {
      ...
      this.state.numbers.forEach(function (x) {
        if (_this2.state.selectors[x]) {
          choices.push(x);
        }
      });
      ...
      if (choices.length > 0) {
        ...
        var op = _operations2.default[this.state.activeOperation];
    ...
    value: function render() {
      return (0, _preact.h)(
        'div',
        { className: (0, _aphrodite.css)(styles.app) },
        (0, _preact.h)(_SelectorBar2.default, {
          numbers: this.state.numbers,
          selectors: this.state.selectors,
          toggleSelector: this.toggleSelector
        }),
        (0, _preact.h)(_OperatorBar2.default, {
          operations: _operations2.default,
          activeOperation: this.state.activeOperation,
          setOperation: this.setOperation
        }),
        (0, _preact.h)(_Question2.default, {
          question: this.state.question,
          generate: this.generateQuestion
        }),
        (0, _preact.h)(_Answer2.default, { answer: this.state.answer })
      );
    }
  }]);
...
var _asap = __webpack_require__(12);
...
var _prefixValue = __webpack_require__(32);
...
var Answer = function (_Component) {
  ...
  function Answer() {
    ...
    _this.setState({ showAnswer: false });
    ...
    value: function render(props) {
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(_Button2.default, { click: this.toggleAnswer, content: 'Toggle Answer' })
        ),
        (0, _preact.h)(
          'div',
          { className: (0, _aphrodite.css)(styles.container, this.state.showAnswer ? null : styles.hidden) },
          (0, _preact.h)(
            'span',
            { className: (0, _aphrodite.css)(styles.answer) },
            props.answer
          )
        )
      );
...
var OperatorBar = function (_Component) {
  _inherits(OperatorBar, _Component);

  function OperatorBar() {
    _classCallCheck(this, OperatorBar);

    return _possibleConstructorReturn(this, (OperatorBar.__proto__ || Object.getPrototypeOf(OperatorBar)).apply(this, arguments));
  }

  _createClass(OperatorBar, [{
    key: 'render',
    value: function render(props) {
      return (0, _preact.h)(
        'div',
        { className: (0, _aphrodite.css)(styles.operatorBar) },
        Object.keys(props.operations).map(function (key) {
          return (0, _preact.h)(_Button2.default, {
            click: function click() {
              return props.setOperation(key);
            },
    ...
    value: function render(props) {
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          'div',
          { className: (0, _aphrodite.css)(styles.container) },
          (0, _preact.h)(_Button2.default, { click: props.generate, content: 'Question' })
        ),
        (0, _preact.h)(
          'div',
          { className: (0, _aphrodite.css)(styles.container) },
          (0, _preact.h)(
            'span',
            { className: (0, _aphrodite.css)(styles.question) },
            props.question
          )
        )
      );
...
var Selector = function (_Component) {
  ...
  _createClass(Selector, [{
    key: 'render',
    value: function render(props) {
      var status = props.active ? styles.active : styles.inactive;

      return (0, _preact.h)(
        'div',
        { className: (0, _aphrodite.css)(styles.selector, status) },
        (0, _preact.h)(
          'div',
          { className: (0, _aphrodite.css)(styles.circle), onClick: function onClick(e) {
              props.toggleSelector(props.number);
            } },
          props.number
        )
      );
...
var _Selector = __webpack_require__(38);
...
var SelectorBar = function (_Component) {
  ...
  function SelectorBar() {
    ...
    return _possibleConstructorReturn(this, (SelectorBar.__proto__ || Object.getPrototypeOf(SelectorBar)).apply(this, arguments));
  }
  ...
  _createClass(SelectorBar, [{
    ...
    value: function render(props) {
      return (0, _preact.h)(
        'div',
        { className: (0, _aphrodite.css)(styles.selectorBar) },
        props.numbers.map(function (x) {
          return (0, _preact.h)(_Selector2.default, {
            number: x,
...
(0, _preact.render)((0, _preact.h)(_App2.default, null), document.getElementById('app'));
